...
public class AdminController {
	...
	@Autowired
	ModalServiceImpl modalServiceImpl;
	@Autowired
	...
	@ResponseBody
	@Transactional
	public String itemAdd(@RequestParam("itemName") String itemName, @RequestParam("price") int price,
			@RequestParam("itemInfoId") int itemInfoId, @RequestParam("category") String category,
	...
	public String itemInfoAdd(@RequestParam("itemType") String itemType,
		...
		type.setItemTypeId(Integer.parseInt(itemType));
	...
	@ResponseBody
	@Transactional
	public String addGroup(@RequestParam(value = "group_name", defaultValue = "0") String name,
	...
	@ResponseBody
	@Transactional
	public String updateGroup(@RequestParam(value = "groupId", defaultValue = "1") int groupId,
	...
	@ResponseBody
	@Transactional
	public String updateAritstName(@RequestParam(value = "artistNId") int artistNId,
			@RequestParam(value = "artistName") String artistName) {
