...
public class MemberServiceImpl implements MemberService {
	...
	public MemberDto findByEmail(String email) {
		MemberEntity memberEntity = memberRepository.findByEmail(email).orElse(null); // 데이터가 없으면 null 반환
	...
	public MemberDto findByEmailAndPw(String email, String pw) {
		MemberEntity memberEntity = memberRepository.findByEmailAndPw(email, pw).orElse(null); // 데이터가 없으면 null 반환
	...
	@Override public void deleteById(int userId) {
		feedRepository.deleteByMember_UserId(userId);
